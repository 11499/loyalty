                        ...
                        <div class="collapse show p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-lg-5 mb-lg-0 mb-3">
                                    <p class="h4 mb-0">Summary</p>@foreach($result as $value)
                                    <p class="mb-0"><span class="fw-bold"></span><span class="c-green">: 
                                            </span>
                                    </p>
                                    <p class="mb-0">
                                ...
                                <div class="col-lg-7">
                                    <form action="/paymentaction/{{$value->gtotal}}" class="form" method="post">@csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form__div">
                                                    <input type="text" name="cno" class="form-control" placeholder=" ">
                                            ...
                                            <div class="col-6">
                                                <div class="form__div">
                                                    <input type="number" name="cvv" class="form-control" placeholder=" ">
                                            ...
                                            <div class="col-12">
                                            <input type="submit" value=" Make Payment" name="submit" class="btn btn-primary payment">
